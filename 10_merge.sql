...
기존 데이터는 email, phone, salary, comm_pct, man_id, dept_id을
업데이트 하도록 처리
새로 유입된 데이터는 그대로 추가.
*/
...
-- 2-3
UPDATE depts SET department_name = 'IT_Help', manager_id = 303, location_id = 1800
WHERE department_name = 'IT Helpdesk';
-- 2-4
UPDATE depts SET manager_id = 301
WHERE department_name IN('회개부', '재정', '인사', '영업');
-- 문제 3
DELETE FROM depts
